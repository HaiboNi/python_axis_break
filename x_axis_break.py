...
dcon = np.array([1e-10, 1, 3, 10, 30, 100])*1e-6
...
gs1 = gridspec.GridSpec(num_row,num_col, width_ratios = (1/ratio,1))


ax = plt.subplot(gs1[0,0]);

ax2 = plt.subplot(gs1[0,1],sharey=ax)



# f, (ax, ax2) = plt.subplots(1, 2, sharey=True)
force = [8.330626015244283,  8.173934774459575,  9.856303886042731, 10.856428839185304, 12.877670873422463, 12.975134324628263]  # expri Schotten et al., 2007
...
ax2.xaxis.set_label_coords(0.35, -0.2)
...
ax2.plot((-d/ratio, +d/ratio), (-d, +d), **kwargs)        # top-left diagonal
...
# ax2.xaxis.tick_bottom()
	...
	plt.subplots_adjust(left=0.18, bottom=0.20, right=0.8, top=0.95,
		wspace=0.09, hspace=0.3)
